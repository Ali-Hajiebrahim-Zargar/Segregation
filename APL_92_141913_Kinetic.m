...
temp=648.15;                      %growth temperature in kelvin
...
if ML_counter>16                                     % change In and Ga phi if 20 ML finished
phi_Ga=1;
phi_In=0;    
end
...
ml=[-1:1:ML+1];
[ml;X_b_In]                                          %print X_b_In for each monolayer
figure
plot(X_b_In,'m-','linewidth',1)
